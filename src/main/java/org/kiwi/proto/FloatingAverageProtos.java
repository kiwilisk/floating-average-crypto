...
public final class FloatingAverageProtos {
    ...
    public static final class Quote extends
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output)
            ...
            if (!getAverageBytes().isEmpty()) {
                com.google.protobuf.GeneratedMessageV3.writeString(output, 4, average_);
            }
            if (updatedAt_ != 0L) {
        ...
        public int getSerializedSize() {
            ...
            if (!getAverageBytes().isEmpty()) {
                size += com.google.protobuf.GeneratedMessageV3.computeStringSize(4, average_);
            }
            if (updatedAt_ != 0L) {
    ...
    public interface FloatingAverageOrBuilder extends
        ...
        /**
         * <code>repeated .floatingquotes.Quote quotes = 1;</code>
         */
        ...
        /**
         * <code>string currentAverage = 2;</code>
         */
        java.lang.String getCurrentAverage();

        /**
         * <code>string currentAverage = 2;</code>
         */
        com.google.protobuf.ByteString
        getCurrentAverageBytes();

        /**
         * <code>int64 closingDate = 3;</code>
         */
        long getClosingDate();

        /**
         * <code>.floatingquotes.FloatingAverage.AlertState alertState = 4;</code>
         */
    ...
    public static final class FloatingAverage extends
        ...
        public static final int CURRENTAVERAGE_FIELD_NUMBER = 2;
        private volatile java.lang.Object currentAverage_;

        /**
         * <code>string currentAverage = 2;</code>
         */
        public java.lang.String getCurrentAverage() {
            java.lang.Object ref = currentAverage_;
            if (ref instanceof java.lang.String) {
                return (java.lang.String) ref;
            } else {
                com.google.protobuf.ByteString bs =
        ...
        public static final int CLOSINGDATE_FIELD_NUMBER = 3;
        ...
        public static final int ALERTSTATE_FIELD_NUMBER = 4;
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output)
            ...
            if (!getCurrentAverageBytes().isEmpty()) {
                com.google.protobuf.GeneratedMessageV3.writeString(output, 2, currentAverage_);
            }
            if (closingDate_ != 0L) {
                output.writeInt64(3, closingDate_);
            }
            if (alertState_ != org.kiwi.proto.FloatingAverageProtos.FloatingAverage.AlertState.NONE.getNumber()) {
                output.writeEnum(4, alertState_);
            }
        }
        ...
        public int getSerializedSize() {
            ...
            if (!getCurrentAverageBytes().isEmpty()) {
                size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, currentAverage_);
            }
            if (closingDate_ != 0L) {
                size += com.google.protobuf.CodedOutputStream
                        .computeInt64Size(3, closingDate_);
            }
            if (alertState_ != org.kiwi.proto.FloatingAverageProtos.FloatingAverage.AlertState.NONE.getNumber()) {
                size += com.google.protobuf.CodedOutputStream
                        .computeEnumSize(4, alertState_);
            }
            memoizedSize = size;
            return size;
        }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            result = result && getCurrentAverage()
                    .equals(other.getCurrentAverage());
        ...
        public int hashCode() {
            ...
            hash = (37 * hash) + CURRENTAVERAGE_FIELD_NUMBER;
            hash = (53 * hash) + getCurrentAverage().hashCode();
        ...
        public static final class Builder extends
            ...
            public org.kiwi.proto.FloatingAverageProtos.FloatingAverage buildPartial() {
                ...
                result.currentAverage_ = currentAverage_;
            ...
            public Builder mergeFrom(org.kiwi.proto.FloatingAverageProtos.FloatingAverage other) {
                ...
                if (!other.getCurrentAverage().isEmpty()) {
                    currentAverage_ = other.currentAverage_;
                    onChanged();
                }
            ...
            private java.lang.Object currentAverage_ = "";
             ...
             * <code>string currentAverage = 2;</code>
             */
            public Builder setCurrentAverage(
                    java.lang.String value) {
                if (value == null) {
                    throw new NullPointerException();
                }

                currentAverage_ = value;
                onChanged();
                return this;
            }
             ...
             * <code>string currentAverage = 2;</code>
             */
            public Builder clearCurrentAverage() {

                currentAverage_ = getDefaultInstance().getCurrentAverage();
                onChanged();
                return this;
            }
             ...
             * <code>string currentAverage = 2;</code>
             */
            public Builder setCurrentAverageBytes(
                    com.google.protobuf.ByteString value) {
                if (value == null) {
                    throw new NullPointerException();
                }
    ...
    static {
        java.lang.String[] descriptorData = {
                "\n\013depot.proto\022\016floatingquotes\"T\n\005Quote\022\n" +
                        "\n\002id\030\001 \001(\t\022\014\n\004name\030\002 \001(\t\022\r\n\005value\030\003 \001(\t\022"
                        +
                        "\017\n\007average\030\004 \001(\t\022\021\n\tupdatedAt\030\005 \001(\003\"\320\001\n\017" +
                        "FloatingAverage\022%\n\006quotes\030\001 \003(\0132\025.floati" +
                        "ngquotes.Quote\022\026\n\016currentAverage\030\002 \001(\t\022\023" +
                        "\n\013closingDate\030\003 \001(\003\022>\n\nalertState\030\004 \001(\0162" +
                        "*.floatingquotes.FloatingAverage.AlertSt" +
                        "ate\")\n\nAlertState\022\010\n\004NONE\020\000\022\007\n\003BUY\020\001\022\010\n\004" +
                        "SELL\020\002B\'\n\016org.kiwi.protoB\025FloatingAverag" +
                        "eProtosb\006proto3"
        };
        ...
        internal_static_floatingquotes_Quote_fieldAccessorTable = new
                com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                internal_static_floatingquotes_Quote_descriptor,
                new java.lang.String[]{"Id", "Name", "Value", "Average", "UpdatedAt",});
        internal_static_floatingquotes_FloatingAverage_descriptor =
                getDescriptor().getMessageTypes().get(1);
        internal_static_floatingquotes_FloatingAverage_fieldAccessorTable = new
                com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                internal_static_floatingquotes_FloatingAverage_descriptor,
                new java.lang.String[]{"Quotes", "CurrentAverage", "ClosingDate", "AlertState",});
    }
